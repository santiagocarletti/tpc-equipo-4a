    ...
    <div class="table-responsive">
      <table class="table table-hover align-middle">
        <thead class="table-light">
          <tr>
            <th>Nombre</th><th>Sector</th><th>Min.</th><th>Estado</th><th class="text-end">Acciones</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>Hamburguesa clasica</td><td>Plancha</td><td>8</td><td><span class="badge text-bg-success">Activo</span></td>
            <td class="text-end">
          ...
          <tr>
            <td>Papas Fritas</td><td>Freidora</td><td>5</td><td><span class="badge text-bg-success">Activo</span></td>
            <td class="text-end">
              <button class="btn btn-outline-secondary btn-sm">Editar</button>
              <button class="btn btn-outline-danger btn-sm">Desactivar</button>
            </td>
          ...
          <tr>
            <td>Gaseosa</td><td>Despacho</td><td>0</td><td><span class="badge text-bg-secondary">Inactivo</span></td>
            <td class="text-end">
              <button class="btn btn-outline-secondary btn-sm">Editar</button>
