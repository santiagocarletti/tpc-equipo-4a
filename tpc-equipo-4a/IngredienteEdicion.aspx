<%@ Page Title="Edición de Ingredientes - Equipo 4A" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="IngredienteEdicion.aspx.cs" Inherits="tpc_equipo_4a.IngredienteEdicion" %>
        ...
        <div class="card mx-auto" style="max-width: 600px;">
            ...
            <div class="card-header">
                <h5>
                    ...
                    <asp:Label ID="lblTitulo" runat="server" Text="Editar Ingrediente"></asp:Label>
                </h5>
            </div>

            <div class="card-body bg-white">
                <div class="mb-3">
                    <label for="txtNombre" class="form-label">Nombre del ingrediente</label>
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" 
                                 placeholder="Ej: Queso Cheddar"></asp:TextBox>
                </div>
